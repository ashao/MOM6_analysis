...
def interpolate_for_nondim_position(dRhoNeg, Pneg, dRhoPos, Ppos):
  if (Ppos<=Pneg):
    ...
    for k_surface in np.arange(0,4*nk):
        ...
        if searching_left_column:
            ...
            if dRhoTop > 0. or kr+kl==0:
              ...
              # In the case where the neutral surface connects at a discontinuity, it belongs to the layer
              # associated with klm1 (e.g. floor(0.5*kr) for 0-indexed languages
              PoL[k_surface] = 1.
            else:
            ...
            if dRhoTop > 0. or kr+kl==0:
              PoR[k_surface] = 0.
              print("Position for dRhoTop > 0 or kr+kl==0")
            elif dRhoTop >= dRhoBot:
              PoR[k_surface] = 1.
              print("Position for dRhoTop >= dRhoBot")
            elif ( dRhoTop<0. and dRhoBot>0.) and ( Pr[krm1]==Pr[kr] ):
              PoR[k_surface] = 1.
              print("Position at a discontinuity")
            else:
